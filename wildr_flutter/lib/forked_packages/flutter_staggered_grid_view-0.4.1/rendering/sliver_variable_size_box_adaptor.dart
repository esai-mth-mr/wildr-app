...
import 'package:wildr_flutter/forked_packages/flutter_staggered_grid_view-0.4.1/rendering/tile_container_render_object_mixin.dart';

/// A delegate used by [RenderSliverVariableSizeBoxAdaptor]
/// to manage its children.
///
/// [RenderSliverVariableSizeBoxAdaptor] objects
/// reify their children lazily to avoid
...
abstract class RenderSliverVariableSizeBoxChildManager {
  ...
  /// specified in the [RenderSliverVariableSizeBoxAdaptor.constraints].
  /// For example
  ...
  /// the [RenderSliverVariableSizeBoxAdaptor] object if
  /// they were not created during
  ...
  /// the [SliverVariableSizeBoxAdaptorParentData.index]
  ...
  /// to the [RenderSliverVariableSizeBoxAdaptor]'s
  /// child list and can simply return
...
///
/// [RenderSliverVariableSizeBoxAdaptor] is a base class for
/// slivers that have multiple
/// variable size box children. The children are
/// managed by a [RenderSliverBoxChildManager],
...
abstract class RenderSliverVariableSizeBoxAdaptor extends RenderSliver
  ...
  /// [RenderSliverVariableSizeBoxAdaptor] uses
  /// a [RenderSliverVariableSizeBoxChildManager] to
  ...
  void remove(int index) {
    ...
    // if child is null, it means this element
    // was cached - drop the cached element
    if (child == null) {
  ...
  void attach(PipelineOwner owner) {
    super.attach(owner);
    for (final child in _keepAliveBucket.values) {
      child.attach(owner);
    }
  }
  ...
  ///
  /// Children whose [SliverVariableSizeBoxAdaptorParentData.keepAlive]
  /// property is
  ...
  /// [SliverVariableSizeBoxAdaptorParentData.index]
  /// field of the child's [parentData].
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    // originOffset gives us the delta from the real
    // origin to the origin in the axis direction.
