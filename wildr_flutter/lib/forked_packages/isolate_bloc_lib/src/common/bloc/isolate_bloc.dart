...
import 'package:wildr_flutter/forked_packages/isolate_bloc_lib/src/common/bloc/isolate_bloc_observer.dart';
...
abstract class IsolateBloc<Event, State> extends IsolateBlocBase<Event, State> {
  ...
  /// executed.
  /// [onTransition] is called before a
  /// [IsolateBloc]'s [state] has been updated.
