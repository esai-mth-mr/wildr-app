...
/// [IsolateBlocBuilder] is analogous
/// to [StreamBuilder] but has simplified API to
/// reduce the amount of boilerplate code needed as well as [bloc]-specific
/// performance improvements.

/// Please refer to [IsolateBlocListener]
/// if you want to "do" anything in response to
...
/// a specified [bloc].
///
/// A [IsolateBlocBuilderBase] is stateful and
...
abstract class IsolateBlocBuilderBase<B extends IsolateBlocBase<Object?, S>, S>
  ...
  const IsolateBlocBuilderBase({super.key, this.bloc, this.buildWhen});

  /// The [bloc] that the [IsolateBlocBuilderBase] will interact with.
  /// If omitted, [IsolateBlocBuilderBase]
...
class _IsolateBlocBuilderBaseState<B extends IsolateBlocBase<Object?, S>, S>
  ...
  @override
  Widget build(BuildContext context) => IsolateBlocListener<B, S>(
        bloc: _bloc,
