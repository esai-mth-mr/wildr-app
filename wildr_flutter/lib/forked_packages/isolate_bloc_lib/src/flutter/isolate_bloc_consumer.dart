...
import 'package:wildr_flutter/forked_packages/isolate_bloc_lib/src/flutter/isolate_bloc_builder.dart';
import 'package:wildr_flutter/forked_packages/isolate_bloc_lib/src/flutter/isolate_bloc_listener.dart';
...
/// [IsolateBlocConsumer] exposes a [builder] and [listener]
/// in order react to new
/// states.
...
/// [IsolateBlocConsumer] should only
/// be used when it is necessary to both rebuild UI
...
class IsolateBlocConsumer<B extends IsolateBlocBase<Object?, S>, S>
  ...
  /// If omitted, [IsolateBlocConsumer] will automatically
  /// perform a lookup using
  /// `BlocProvider` and the current `BuildContext`.
  final WildrGqlIsolateBlocWrapper? bloc;
...
class _IsolateBlocConsumerState<B extends IsolateBlocBase<Object?, S>, S>
  ...
  late WildrGqlIsolateBlocWrapper _bloc;
  ...
  @override
  Widget build(BuildContext context) => IsolateBlocBuilder<B, S>(
        bloc: _bloc,
