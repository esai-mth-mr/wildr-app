...
class CropState extends State<Cropper>
  ...
  @override
  void didUpdateWidget(Cropper oldWidget) {
  ...
  Widget build(BuildContext context) => ConstrainedBox(
        constraints:
            BoxConstraints.tightForFinite(width: Get.width, height: 762),
        child: Listener(
  ...
  void _updateArea({
    ...
    final double width = areaRight - areaLeft;
...
class _CropPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (image != null) {
      ...
      canvas..save()
      ..clipRect(Rect.fromLTWH(0.0, 0.0, rect.width, rect.height))
