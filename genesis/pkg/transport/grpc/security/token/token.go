...
import (
	...
	"github.com/wildr-inc/app/genesis/pkg/security/header"
...
func (p *tokenPerRPCCredentials) GetRequestMetadata(
	ctx context.Context,
	_ ...string,
	...
	return map[string]string{
		"authorization": fmt.Sprintf("%s %s", header.BearerAuthorization, t),
	}, nil
}
