...
import (
	...
	"github.com/wildr-inc/app/genesis/pkg/transport/grpc/breaker"
	"github.com/wildr-inc/app/genesis/pkg/transport/grpc/meta"
	"github.com/wildr-inc/app/genesis/pkg/transport/grpc/retry"
	szap "github.com/wildr-inc/app/genesis/pkg/transport/grpc/telemetry/logger/zap"
	"github.com/wildr-inc/app/genesis/pkg/transport/grpc/telemetry/metrics"
...
func WithClientUnaryInterceptors(
	unary ...grpc.UnaryClientInterceptor,
) ClientOption {
	return clientOptionFunc(func(o *clientOptions) {
		o.unary = unary
...
func streamDialOption(opts *clientOptions) (grpc.DialOption, error) {
	stream := []grpc.StreamClientInterceptor{
		meta.StreamClientInterceptor(opts.userAgent),
	}
