...
import (
	...
	shttp "github.com/wildr-inc/app/genesis/pkg/http"
	tstrings "github.com/wildr-inc/app/genesis/pkg/transport/strings"
...
func NewHandler(meter metric.Meter) (*Handler, error) {
	...
	received, err := meter.Int64Counter(
		"http_server_msg_received_total",
...
func (h *Handler) ServeHTTP(
	...
	h.handled.Add(
		...
		1,
		opts,
		metric.WithAttributes(attribute.Key("http_code").Int(res.StatusCode)),
	)
...
func NewRoundTripper(
	...
	received, err := meter.Int64Counter(
		"http_client_msg_received_total",
		metric.WithDescription(
...
func (r *RoundTripper) RoundTrip(req *http.Request) (*http.Response, error) {
	...
	r.handled.Add(
		...
		1,
		opts,
		metric.WithAttributes(attribute.Key("http_code").Int(resp.StatusCode)),
	)
