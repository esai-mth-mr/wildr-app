...
import (
	...
	stime "github.com/wildr-inc/app/genesis/pkg/time"
...
func (i *Interceptor) ConnBeginTx(
	ctx context.Context,
...
func (i *Interceptor) ConnPrepareContext(
	ctx context.Context,
...
//
//nolint:dupl
func (i *Interceptor) ConnExecContext(
	ctx context.Context,
	...
	if d, ok := ctx.Deadline(); ok {
		fields = append(
			fields,
			zap.String(fmt.Sprintf(deadline, i.name), d.Format(time.RFC3339)),
		)
	}
	...
	fields = append(
		fields,
		zap.Int64(
			fmt.Sprintf(duration, i.name),
			stime.ToMilliseconds(time.Since(start)),
		),
	)

	if err != nil {
		fields = append(fields, zap.Error(err))
		i.logger.Error("finished sql call with error", fields...)
...
func (i *Interceptor) ConnQueryContext(
	ctx context.Context,
...
func (i *Interceptor) ConnectorConnect(
	ctx context.Context,
	connect driver.Connector,
) (driver.Conn, error) {
...
//
//nolint:dupl
func (i *Interceptor) StmtExecContext(
	ctx context.Context,
...
func (i *Interceptor) StmtQueryContext(
	ctx context.Context,
